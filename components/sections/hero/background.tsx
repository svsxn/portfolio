export default function Background() {
  return (
    <div className="pointer-events-none absolute left-1/2 top-0 -z-20 h-full w-screen -translate-x-1/2 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.025] bg-[linear-gradient(--alpha(var(--foreground)/60%)_1px,transparent_1px),linear-gradient(90deg,--alpha(var(--foreground)/60%)_1px,transparent_1px)] bg-size-[80px_80px]" />
